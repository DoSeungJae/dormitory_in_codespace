...
public class NotificationConstants {
    ...
    public static final String GROUP_CLOSED_KOR="참여하신 그룹(%s)이 마감되었어요. "; // %s <- room <- 사용자 경험을 위해 %s는 제외하는게 나아보임
    public static final String GROUP_FINISHED_KOR="참여하신 그룹(%s)이 종료되었어요."; // %s <- room <- 사용자 경험을 위해 %s는 제외하는게 나아보임
